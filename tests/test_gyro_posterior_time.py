...
401 ages, N=256 grid:
    ...
    * parallel_gyro_age_posterior takes 4 seconds.

401 ages, N=512 grid:
    * gyro_age_posterior takes 10 seconds.
    * parallel_gyro_age_posterior takes 6 seconds.

1001 ages, N=256 grid:
    * gyro_age_posterior takes 10 seconds.
    * parallel_gyro_age_posterior takes 5 seconds.

where the macbook has 16 cores to use during parallel_gyro_age_posterior.
"""
import os
